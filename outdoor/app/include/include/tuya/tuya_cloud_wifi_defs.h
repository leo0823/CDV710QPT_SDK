...
/***********************************************************
*  callback function: WF_LOCK_CHAN_NOTIFY_CB
*  Desc:    wifi lock channel callback
*  Input:   lock_status: TRUE - channel locked, FALSE - channel unlocked
*  Input:   lock_chan: locked channel
***********************************************************/
typedef VOID (*WF_LOCK_CHAN_NOTIFY_CB)(IN CONST BOOL_T lock_status,IN CONST INT_T lock_chan);
