...
#define CARD_TYPE_LEN           16
#define ICCID_LEN               20
#define IMEI_LEN                15
#define PROVIDER_ID_LEN         16
...
typedef BYTE_T GW_TRAFFIC_STATUS_E;
#define GW_TRAFFIC_FREEZE   0 // 4g traffic expired
#define GW_TRAFFIC_NORMAL   1 // 4g traffic normal

/***********************************************************
*  callback function: GW_TRAFFIC_CHANGED_CB
*  Desc:    gw traffic changed callback
*  Input:   status: current status
***********************************************************/
typedef VOID (*GW_TRAFFIC_CHANGED_CB)(IN CONST GW_TRAFFIC_STATUS_E status);
...
typedef struct {
    ...
    GW_TRAFFIC_CHANGED_CB gw_traffic_status_cb;
}TY_IOT_CBS_S;
...
/**
 * \brief network detetction info
 * \struct NETWORK_DETECTION_SERVICES_INFO_S
 */
#define NETWORK_DETECTION_TOOL_NAME_LEN 17
#define NETWORK_DETECTION_ID_LEN 64
#define NETWORK_SERVICE_NAME_LEN 17
#define NETWORK_SERVICE_URL_LEN 17
#define NETWORK_SERVCIE_PROTOCOL_LEN 8
#define NETWORK_SERVICE_MAX 8
typedef struct{
    CHAR_T serviceName[NETWORK_SERVICE_NAME_LEN];
    CHAR_T serviceURL[NETWORK_SERVICE_URL_LEN];
    CHAR_T serviceProtocol[NETWORK_SERVCIE_PROTOCOL_LEN];
    INT_T servicePort;
}NETWORK_DETECTION_SERVICES_INFO_S;

typedef OPERATE_RET(*TUAY_IPC_NETWORK_DETECTION_START)(IN NETWORK_DETECTION_SERVICES_INFO_S * detectionInfo,OUT CHAR_T *rawResult,OUT INT_T *len);
