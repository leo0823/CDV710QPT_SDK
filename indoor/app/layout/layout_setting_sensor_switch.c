        ...
        ***********************************************/
        {
                setting_list_info_t main_list_group[] = {
                    ...
                    {0, 0, 928, 72,
                     ...
                     SETTING_SENSOR_USAGE_LANG_ID_NOT_USED, layout_setting_sensor_usage_language_get,
                    ...
                    {0, 72, 928, 72,
                     ...
                     SETTING_SENSOR_USAGE_LANG_ID_SENSOR_FOR_SECURITY, layout_setting_sensor_usage_language_get,
                     setting_sensor_switch_list_click, 2},
                    {0, 72 * 2, 928, 72,
