...
enum
{
        ...
        ** 说明: ip文本框
        ***********************************************/
        setting_server_ipaddress_obj_id_product_ip_textbox,
        setting_server_ipaddress_obj_id_default_gateway_textbox,
        setting_server_ipaddress_obj_id_subnet_mask_textbox,
        setting_server_ipaddress_obj_id_dns_textbox,
        /***********************************************
        ** 作者: leo.liu
        ** 日期: 2023-2-1 13:43:33
        ** 说明: ip文本显示
        ***********************************************/
        setting_server_ipaddress_obj_id_product_ip_label,
        setting_server_ipaddress_obj_id_default_gateway_label,
...
static void sat_layout_enter(setting_server_ipaddress)
{
        ...
        ***********************************************/
        {
                lv_common_textarea_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_product_ip_textbox, 298, 166, 250, 50,
        ...
        ***********************************************/
        {
                lv_common_text_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_product_ip_label, 32, 173, 200, 50,
                                      NULL, LV_OPA_TRANSP, 0, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      layout_server_operation_network_language_get(SERVER_OPERATION_NETWORK_ID_LANG_LOCAL_SERVER), 0XFFFFFFFF, 0xFFFFFF, LV_TEXT_ALIGN_LEFT, lv_font_normal);
        }
        /***********************************************
         ** 作者: leo.liu
         ** 日期: 2023-2-2 13:43:29
         ...
         ***********************************************/
        {
                lv_common_textarea_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_default_gateway_textbox, 298, 250, 250, 50,
                                          NULL, LV_OPA_TRANSP, 0, LV_OPA_COVER, 0X101010,
                                          LV_OPA_TRANSP, 0Xffffff, LV_OPA_COVER, 0Xffffff,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0X101010,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0x00a8ff,
        ...
        ***********************************************/
        {
                lv_common_text_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_default_gateway_label, 32, 257, 200, 50,
                                      NULL, LV_OPA_TRANSP, 0, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      layout_server_operation_network_language_get(SERVER_OPERATION_NETWORK_ID_LANG_SIP_SERVER), 0XFFFFFFFF, 0xFFFFFF, LV_TEXT_ALIGN_LEFT, lv_font_normal);
        }
        /***********************************************
         ** 作者: leo.liu
         ** 日期: 2023-2-2 13:43:29
         ...
         ***********************************************/
        {
                lv_common_textarea_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_subnet_mask_textbox, 298, 334, 250, 50,
                                          NULL, LV_OPA_TRANSP, 0, LV_OPA_COVER, 0X101010,
                                          LV_OPA_TRANSP, 0Xffffff, LV_OPA_COVER, 0Xffffff,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0X101010,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0x00a8ff,
        ...
        ***********************************************/
        {
                lv_common_text_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_subnet_mask_label, 32, 341, 200, 50,
                                      NULL, LV_OPA_TRANSP, 0, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      layout_server_operation_network_language_get(SERVER_OPERATION_NETWORK_ID_LANG_UPDATE_SERVER), 0XFFFFFFFF, 0xFFFFFF, LV_TEXT_ALIGN_LEFT, lv_font_normal);
        }
        /***********************************************
         ** 作者: leo.liu
         ** 日期: 2023-2-2 13:43:29
         ...
         ***********************************************/
        {
                lv_common_textarea_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_dns_textbox, 298, 418, 250, 50,
                                          NULL, LV_OPA_TRANSP, 0, LV_OPA_COVER, 0X101010,
                                          LV_OPA_TRANSP, 0Xffffff, LV_OPA_COVER, 0Xffffff,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0X101010,
                                          9, 2, LV_BORDER_SIDE_FULL, LV_OPA_COVER, 0x00a8ff,
        ...
        ***********************************************/
        {
                lv_common_text_create(sat_cur_layout_screen_get(), setting_server_ipaddress_obj_id_dns_label, 32, 425, 200, 50,
                                      NULL, LV_OPA_TRANSP, 0, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      0, 0, LV_BORDER_SIDE_NONE, LV_OPA_TRANSP, 0,
                                      layout_server_operation_network_language_get(SERVER_OPERATION_NETWORK_ID_LANG_CCTV_SERVER), 0XFFFFFFFF, 0xFFFFFF, LV_TEXT_ALIGN_LEFT, lv_font_normal);
        }
}
