...
static void sat_layout_enter(setting_common_entrance_ip)
{
        ...
        ***********************************************/
        {
                lv_common_number_input_keyboard_create(sat_cur_layout_screen_get(), setting_common_entrance_ip_obj_id_number_keyboard_btn, 608, 127, 312, 402,
                                                       setting_common_entrance_ip_obj_keyboad_click, LV_OPA_COVER, 0x808080, LV_OPA_COVER, 0x00a8ff,
