...
sat_layout_define(door_camera_registed);
sat_layout_define(door_camera_search);
sat_layout_define(camera_search_display);
...
sat_layout_define(cctv_registered);
sat_layout_define(cctv_search);
sat_layout_define(cctv_search_display);
sat_layout_define(cctv_serch_input);
