...
#define LV_TRACE_OBJ_CREATE(...)
	 ...
	 * @return:
	 */
	lv_obj_t *lv_obj_get_child_form_id(const lv_obj_t *parent, int id);
	 ...
	 * @return:
	 */
	void lv_obj_set_id(lv_obj_t *obj, int id);
	void *lv_obj_set_img_src(lv_obj_t *obj, const void *src);
	const void *lv_obj_get_img_src(lv_obj_t *obj);
	void lv_obj_set_state_bind(lv_obj_t *obj, lv_obj_t *bind_obj);
#endif
