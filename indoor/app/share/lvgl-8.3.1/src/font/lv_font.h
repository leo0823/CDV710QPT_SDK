...
#define 	LV_FONT_DECLARE(font_name) extern const lv_font_t font_name;
	 ...
	 * @注释: 声明字号
	 */
	extern lv_font_t * lv_font_small;
	extern lv_font_t * lv_font_normal;
	extern lv_font_t * lv_font_large;
	extern lv_font_t * lv_font_large_s;
	extern lv_font_t * lv_font_plus;
