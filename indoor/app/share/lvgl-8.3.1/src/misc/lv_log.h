...
#define LV_LOG_LEVEL_USER  2 /**< Custom logs from the user*/
#define LV_LOG_LEVEL_WARN  3 /**< Log if something unwanted happened but didn't caused problem*/
#define LV_LOG_LEVEL_ERROR 4 /**< Only critical issue, when the system may fail*/
