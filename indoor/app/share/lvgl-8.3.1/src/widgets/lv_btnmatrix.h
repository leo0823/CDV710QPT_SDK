...
#define 	LV_BTNMATRIX_BTN_NONE	0xFFFF
	...
	typedef struct {
		lv_btnmatrix_ctrl_t pad_width;
		lv_btnmatrix_ctrl_t pad_height;
	} lv_btnmatrix_pad_info_t;
...
#if SAT_LV_ADD_CUSTOM
		const char * *bg_img_p;
		lv_btnmatrix_pad_info_t * pad_info_p;																																																																																																																			/*Array of control bytes*/
#endif
...
#if SAT_LV_ADD_CUSTOM
	void lv_btnmatrix_set_pad_map(lv_obj_t * obj, const lv_btnmatrix_pad_info_t ctrl_map[]);
#endif
...
#if SAT_LV_ADD_CUSTOM
	void lv_btnmatrix_set_btn_bg_map(lv_obj_t * obj, const char * map[]);
